...
const presets = [['@babel/preset-env', { loose: true, modules: false }], '@babel/preset-typescript'];

const plugins = ['@vue/babel-plugin-jsx', '@babel/plugin-transform-runtime', '@babel/plugin-proposal-class-properties'];
