 ...
 * @Last Modified time: 2021-03-08 13:07:35
 */
  ...
  methods: {
    ...
    renderPrevPage(h) {
      return h(
        'span',
        {
          ...
          attrs: {
            title: t('qm.table.pagination.prev'),
          },
          on: {
            click: this.prevPage,
          },
    ...
    renderPrevJump(h, tagName) {
      return h(
        tagName || 'span',
        {
          ...
          attrs: {
            title: t('qm.table.pagination.jumpPrev'),
          },
          on: {
            click: this.prevJump,
          },
    ...
    renderNextJump(h, tagName) {
      return h(
        tagName || 'span',
        {
          ...
          attrs: {
            title: t('qm.table.pagination.jumpNext'),
          },
          on: {
            click: this.nextJump,
          },
    ...
    renderNextPage(h) {
      return h(
        'span',
        {
          ...
          attrs: {
            title: t('qm.table.pagination.next'),
          },
          on: {
            click: this.nextPage,
          },
      ...
      return (
        ...
        >
          {this.pageSizeOptions.map((x) => (
            <el-option key={x} label={`${x}${t('qm.table.pagination.pagesize')}`} value={x} />
          ))}
        </el-select>
      );
    },
        ...
        [
          ...
          isFull
            ? h(
                ...
                t('qm.table.pagination.pageClassifier')
              )
            : null,
        ]
      );
    ...
    renderTotal(h) {
      return h(
        ...
        t('qm.table.pagination.total', { total: this.total })
      );
    },
    // number
